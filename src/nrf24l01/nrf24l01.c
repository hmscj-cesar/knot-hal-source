...
static void set_address_pipe(int8_t spi_fd, uint8_t reg, uint8_t *pipe_addr)
{
	...
	switch (reg) {
	case NRF24_TX_ADDR:
		nrf24data_write(spi_fd, NRF24_TX_ADDR, &addr, sizeof(addr));
		break;
	case NRF24_RX_ADDR_P0:
		nrf24data_write(spi_fd, NRF24_RX_ADDR_P0, &addr, sizeof(addr));
		break;
	case NRF24_RX_ADDR_P1:
		nrf24data_write(spi_fd, NRF24_RX_ADDR_P1, &addr, sizeof(addr));
		break;
	#ifndef ARDUINO
	case NRF24_RX_ADDR_P2:
		nrf24data_write(spi_fd, NRF24_RX_ADDR_P2, &addr, sizeof(addr));
		break;
	case NRF24_RX_ADDR_P3:
		nrf24data_write(spi_fd, NRF24_RX_ADDR_P3, &addr, sizeof(addr));
		break;
	case NRF24_RX_ADDR_P4:
		nrf24data_write(spi_fd, NRF24_RX_ADDR_P4, &addr, sizeof(addr));
		break;
	case NRF24_RX_ADDR_P5:
		nrf24data_write(spi_fd, NRF24_RX_ADDR_P5, &addr, sizeof(addr));
		break;
	#endif
	default:
		break;
...
static uint8_t *get_address_pipe(int8_t spi_fd, uint8_t pipe)
{
	...
	/* Fecht access address from */
	switch (pipe_reg[pipe].rx_addr) {
	case NRF24_TX_ADDR:
		nrf24data_read(spi_fd, NRF24_TX_ADDR, pipe_addr, 5);
		break;
	case NRF24_RX_ADDR_P0:
		nrf24data_read(spi_fd, NRF24_RX_ADDR_P0, pipe_addr, 5);
		break;
	case NRF24_RX_ADDR_P1:
		nrf24data_read(spi_fd, NRF24_RX_ADDR_P1, pipe_addr, 5);
		break;
	#ifndef ARDUINO
	case NRF24_RX_ADDR_P2:
		nrf24data_read(spi_fd, NRF24_RX_ADDR_P2, pipe_addr, 5);
		break;
	case NRF24_RX_ADDR_P3:
		nrf24data_read(spi_fd, NRF24_RX_ADDR_P3, pipe_addr, 5);
		break;
	case NRF24_RX_ADDR_P4:
		nrf24data_read(spi_fd, NRF24_RX_ADDR_P4, pipe_addr, 5);
		break;
	case NRF24_RX_ADDR_P5:
		nrf24data_read(spi_fd, NRF24_RX_ADDR_P5, pipe_addr, 5);
		break;
	#endif
	default:
		break;
